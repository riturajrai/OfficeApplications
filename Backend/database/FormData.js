...
const postInfo = async (req, res) => {
    upload(req, res, async (err) => {
        ...
        try {
            ...
            // Enhanced email template with better UX
            const mailOptions = {
                    ...
                    <body>
                        <div class="email-container">
                            ...
                            <div class="email-body">
                                ...
                                <p>We've successfully received your application for a position at <span class="highlight">Company</span> Here's what happens next:</p>
                                
                                <div class="divider"></div>
                                
                                <p><strong>Application Review</strong><br>
                                Our HR team will carefully review your qualifications. This process typically takes 1-2 business days.</p>
                                
                                <p><strong>Next Steps</strong><br>
                                If your profile matches our requirements, we'll contact you via email or phone to next steps.</p>
                                
                                <div class="cta-container">
                                    <a href="https://vocalheart.com/careers" class="cta-button">
                                        View Current Openings
                                    </a>
                                </div>
                                
                                <p>For any questions, please reply to this email or contact our HR team at <a href="mailto:hr@vocalheart.com" style="color: #003087;">hr@vocalheart.com</a>.</p>
                                
                                <p>Best regards,<br>
                                <strong>The Vocal Heart HR Team</strong></p>
                            </div>
                            ...
                            <div class="email-footer">
                                ...
                                <p style="margin-top: 12px; color: #adb5bd;">
                                    &copy; ${new Date().getFullYear()} VocalHeart Infotech. All rights reserved.<br>
                                    This email was sent to ${email} as part of your application process.
                                </p>
                            </div>
                        </div>
                    </body>
